...
<head>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link href="{{asset('backedn/assets/plugins/toaster/toastr.min.css')}} " rel="stylesheet" />
    <link href="{{asset('backedn/assets/plugins/nprogress/nprogress.css')}}  " rel="stylesheet" />
    <link href="{{asset('backedn/assets/plugins/flag-icons/css/flag-icon.min.css')}} " rel="stylesheet" />
    <link href="{{asset('backedn/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.css')}} " rel="stylesheet" />
    <link href="{{asset('backedn/assets/plugins/ladda/ladda.min.css')}} " rel="stylesheet" />
    <link href="{{asset('backedn/assets/plugins/select2/css/select2.min.css')}} " rel="stylesheet" />
    <link href="{{asset('backedn/assets/plugins/daterangepicker/daterangepicker.css')}}" rel="stylesheet" />
